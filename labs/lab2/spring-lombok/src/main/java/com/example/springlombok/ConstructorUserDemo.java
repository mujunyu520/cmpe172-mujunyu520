...
public class ConstructorUserDemo {
    ...
    public static void print()
    {
        ...
        // for checking the constructor has all arguments or no arguments
        System.out.println("\nConstructor:");
        Constructor gmConstructor[] = gmClass.getConstructors();
        for(int i = 0; i < gmConstructor.length; i++) {
            Constructor theConstructor = gmConstructor[i];
            String constructor = theConstructor.toString();
            System.out.format("  %s\n", constructor);
        }
